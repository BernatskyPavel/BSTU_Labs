...
_tmain(int argc, TCHAR* argv[])
{
  if (argc < 4) {
    ...
    _tprintf_s(
      _T("Usage: Lab-05-03.exe <Affinity> <Process priority> <Thread 1 ")
      _T("priority> <Thread 2 priority>\n"));
    _tprintf_s(_T("Affinity: Number which binary representation show which ")
               _T("cores of CPU can be used by process.\n"));
  ...
  hThread1 =
    CreateThread(NULL, 0, threadProc, NULL, CREATE_SUSPENDED, &dwThread1Id);
  ...
  hThread2 =
    CreateThread(NULL, 0, threadProc, NULL, CREATE_SUSPENDED, &dwThread2Id);
...
//print_help()
//{
//  _tprintf_s(_T("Usage: Lab-05-03.exe <Affinity> <Process priority> <Thread 1 ")
//             _T("priority> <Thread 2 priority>\n"));
//  _tprintf_s(_T("Affinity: Number which binary representation show which ")
//             _T("cores of CPU can be used by process.\n"));
//  _tprintf_s(_T("Process Info:\n"));
