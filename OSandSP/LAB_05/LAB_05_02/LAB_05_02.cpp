// LAB_05_02.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
void print_help() {
	_tprintf_s(_T("Usage: LAB_05_02.exe <Affinity> <Subprocess 1 priority> <Subprocess 2 priority>\n"));
