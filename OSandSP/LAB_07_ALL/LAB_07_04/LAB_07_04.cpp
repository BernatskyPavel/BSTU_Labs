...
{
	HANDLE hSemaphore = CreateSemaphore(NULL, 2, 2, _T("LAB_07_Semaphore"));
	...
	TCHAR cmd1[256]; _tcscpy_s(cmd1, _T(".\\LAB_07_04A.exe"));
	TCHAR cmd2[256]; _tcscpy_s(cmd2, _T(".\\LAB_07_04A.exe"));
	...
	for (i; i < 30; i++)
	{
		_tprintf_s(_T("Process(Main): %I64u\n"), i);
		Sleep(100);
	}
