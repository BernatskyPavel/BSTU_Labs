...
int _tmain(int argc, TCHAR** argv)
{
	...
	HANDLE hMutex = CreateMutex(&security, FALSE, _T("LAB_07_Mutex"));
	...
	TCHAR cmd1[256]; _tcscpy_s(cmd1, _T(".\\LAB_07_03A.exe"));
	TCHAR cmd2[256]; _tcscpy_s(cmd2, _T(".\\LAB_07_03A.exe"));
