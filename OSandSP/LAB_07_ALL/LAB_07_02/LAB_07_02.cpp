...
int _tmain()
{
	DWORD
		...
		dwThread2Id;
	HANDLE
		hThread1 = CreateThread(NULL, 0, threadProc, (LPVOID)L"Thread A", CREATE_SUSPENDED, &dwThread1Id),
		hThread2 = CreateThread(NULL, 0, threadProc, (LPVOID)L"Thread B", CREATE_SUSPENDED, &dwThread2Id);
