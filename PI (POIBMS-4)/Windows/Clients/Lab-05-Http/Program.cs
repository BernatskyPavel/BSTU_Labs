...
using Lab_05_Http.WCFSimplexConsole;
//using Lab_05_Http.WCFSimplexIIS;

namespace Lab_05_Http {
    class Program {
        static void Main(string[] args)
        {
            WCFSimplexClient service = new WCFSimplexClient("BasicHttpBinding_IWCFSimplex");
            service.Open();
            try {
